...
from AppCore import get_plugin_registry
...
def test_registry_button_ids_unique():
...
def test_page_routes_contains_core_entries():
...
def test_default_page_exists_in_routes():
...
def test_builtin_page_plugins_registered():
