...
class P2PTestDataBasePage:
    ...
    def load_page(self: object) -> None:
        ...
        P2PTestDataBasePage._build_left_section(self, page_layout)
        right_back_layout = P2PTestDataBasePage._build_right_container(self, page_layout)
        P2PTestDataBasePage._build_top_section(self, right_back_layout)
        P2PTestDataBasePage._build_filter_section(self, right_back_layout)
        P2PTestDataBasePage._build_database_cards(self, right_back_layout)
