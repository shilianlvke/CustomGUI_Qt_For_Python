...
from AppCore.system.module.attrdict import AttrDict
...
from AppCore.system.module.settings_module import SettingsValidationError, validate_language_data
...
class ConfigHandler:
    ...
    def _build_named_yaml_map(path_list: list[str]) -> AttrDict:
        ...
        """
        yaml_handler = importlib.import_module("AppCore.system.handler.yaml_handler").YamlHandler
